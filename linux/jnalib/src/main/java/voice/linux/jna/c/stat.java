...
/**
 * Versions of the `xmknod' interface.<br>
 * <i>native declaration : ..\voice\local\headers\\usr\include\arm-linux-gnueabihf\bits\stat.h:38</i><br>
...
public class stat extends Structure {
	...
	public long __glibc_reserved4;
	public long __glibc_reserved5;
	public stat() {
		super();
	}
	protected List<? > getFieldOrder() {
		return Arrays.asList("st_dev", "__pad1", "st_ino", "st_mode", "st_nlink", "st_uid", "st_gid", "st_rdev", "__pad2", "st_size", "st_blksize", "st_blocks", "st_atim", "st_mtim", "st_ctim", "__glibc_reserved4", "__glibc_reserved5");
	}
