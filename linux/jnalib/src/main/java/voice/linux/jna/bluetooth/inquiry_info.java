 ...
 */
public class inquiry_info extends Structure<inquiry_info, inquiry_info.ByValue, inquiry_info.ByReference > {
	/** C type : bdaddr_t */
	...
	protected List<? > getFieldOrder() {
		return Arrays.asList("bdaddr", "pscan_rep_mode", "pscan_period_mode", "pscan_mode", "dev_class", "clock_offset");
	}
	/**
	 * @param bdaddr C type : bdaddr_t<br>
	 * @param dev_class C type : uint8_t[3]
	 */
	public inquiry_info(bdaddr_t bdaddr, byte pscan_rep_mode, byte pscan_period_mode, byte pscan_mode, byte dev_class[], short clock_offset) {
		super();
		this.bdaddr = bdaddr;
	...
	public inquiry_info(Pointer peer) {
		super(peer);
	}
	protected ByReference newByReference() { return new ByReference(); }
	protected ByValue newByValue() { return new ByValue(); }
	protected inquiry_info newInstance() { return new inquiry_info(); }
	public static inquiry_info[] newArray(int arrayLength) {
		return Structure.newArray(inquiry_info.class, arrayLength);
	}
