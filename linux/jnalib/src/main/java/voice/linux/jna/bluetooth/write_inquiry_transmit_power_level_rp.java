...
public class write_inquiry_transmit_power_level_rp extends Structure {
	...
	public write_inquiry_transmit_power_level_rp(byte status) {
		super();
		this.status = status;
	}
	...
	public static class ByValue extends write_inquiry_transmit_power_level_rp implements Structure.ByValue {
