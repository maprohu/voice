 ...
 */
public class set_event_mask_cp extends Structure<set_event_mask_cp, set_event_mask_cp.ByValue, set_event_mask_cp.ByReference > {
	/** C type : uint8_t[8] */
	...
	protected set_event_mask_cp newInstance() { return new set_event_mask_cp(); }
	public static set_event_mask_cp[] newArray(int arrayLength) {
		return Structure.newArray(set_event_mask_cp.class, arrayLength);
	}
