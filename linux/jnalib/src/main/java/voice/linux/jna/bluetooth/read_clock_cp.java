 ...
 */
public class read_clock_cp extends Structure<read_clock_cp, read_clock_cp.ByValue, read_clock_cp.ByReference > {
	public short handle;
	...
	protected read_clock_cp newInstance() { return new read_clock_cp(); }
	public static read_clock_cp[] newArray(int arrayLength) {
		return Structure.newArray(read_clock_cp.class, arrayLength);
	}
