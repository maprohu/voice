 ...
 */
public class read_scan_enable_rp extends Structure<read_scan_enable_rp, read_scan_enable_rp.ByValue, read_scan_enable_rp.ByReference > {
	public byte status;
	public byte enable;
	...
	protected read_scan_enable_rp newInstance() { return new read_scan_enable_rp(); }
	public static read_scan_enable_rp[] newArray(int arrayLength) {
		return Structure.newArray(read_scan_enable_rp.class, arrayLength);
	}
