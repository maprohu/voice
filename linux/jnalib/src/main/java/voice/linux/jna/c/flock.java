...
/**
 * O_*, F_*, FD_* bit values for Linux.<br>
 * Copyright (C) 1995-2014 Free Software Foundation, Inc.<br>
 ...
 * <i>native declaration : ..\voice\local\headers\\usr\include\arm-linux-gnueabihf\bits\fcntl.h:28</i><br>
...
public class flock extends Structure {
	 ...
	 * C type : __pid_t
	 */
	public flock(short l_type, short l_whence, long l_start, long l_len, int l_pid) {
		super();
		this.l_type = l_type;
