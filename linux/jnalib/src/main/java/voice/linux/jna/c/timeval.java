 ...
 */
public class timeval extends Structure<timeval, timeval.ByValue, timeval.ByReference > {
	/**
	 * Seconds.<br>
	 * C type : __time_t
	 */
	...
	protected timeval newInstance() { return new timeval(); }
	public static timeval[] newArray(int arrayLength) {
		return Structure.newArray(timeval.class, arrayLength);
	}
