 ...
 */
public class hci_conn_info_req extends Structure<hci_conn_info_req, hci_conn_info_req.ByValue, hci_conn_info_req.ByReference > {
	/** C type : bdaddr_t */
	...
	protected hci_conn_info_req newInstance() { return new hci_conn_info_req(); }
	public static hci_conn_info_req[] newArray(int arrayLength) {
		return Structure.newArray(hci_conn_info_req.class, arrayLength);
	}
