 ...
 */
public class create_physical_link_cp extends Structure<create_physical_link_cp, create_physical_link_cp.ByValue, create_physical_link_cp.ByReference > {
	public byte handle;
	...
	protected create_physical_link_cp newInstance() { return new create_physical_link_cp(); }
	public static create_physical_link_cp[] newArray(int arrayLength) {
		return Structure.newArray(create_physical_link_cp.class, arrayLength);
	}
