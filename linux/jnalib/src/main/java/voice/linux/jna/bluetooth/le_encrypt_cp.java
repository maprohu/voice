 ...
 */
public class le_encrypt_cp extends Structure<le_encrypt_cp, le_encrypt_cp.ByValue, le_encrypt_cp.ByReference > {
	/** C type : uint8_t[16] */
	...
	protected le_encrypt_cp newInstance() { return new le_encrypt_cp(); }
	public static le_encrypt_cp[] newArray(int arrayLength) {
		return Structure.newArray(le_encrypt_cp.class, arrayLength);
	}
