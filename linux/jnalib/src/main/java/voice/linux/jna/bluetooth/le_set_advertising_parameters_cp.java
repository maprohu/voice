 ...
 */
public class le_set_advertising_parameters_cp extends Structure<le_set_advertising_parameters_cp, le_set_advertising_parameters_cp.ByValue, le_set_advertising_parameters_cp.ByReference > {
	...
	protected le_set_advertising_parameters_cp newInstance() { return new le_set_advertising_parameters_cp(); }
	public static le_set_advertising_parameters_cp[] newArray(int arrayLength) {
		return Structure.newArray(le_set_advertising_parameters_cp.class, arrayLength);
	}
