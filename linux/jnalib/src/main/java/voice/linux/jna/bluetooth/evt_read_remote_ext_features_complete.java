 ...
 */
public class evt_read_remote_ext_features_complete extends Structure<evt_read_remote_ext_features_complete, evt_read_remote_ext_features_complete.ByValue, evt_read_remote_ext_features_complete.ByReference > {
	public byte status;
	public short handle;
	...
	protected evt_read_remote_ext_features_complete newInstance() { return new evt_read_remote_ext_features_complete(); }
	public static evt_read_remote_ext_features_complete[] newArray(int arrayLength) {
		return Structure.newArray(evt_read_remote_ext_features_complete.class, arrayLength);
	}
