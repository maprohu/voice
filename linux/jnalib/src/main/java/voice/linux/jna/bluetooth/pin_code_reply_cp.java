 ...
 */
public class pin_code_reply_cp extends Structure<pin_code_reply_cp, pin_code_reply_cp.ByValue, pin_code_reply_cp.ByReference > {
	/** C type : bdaddr_t */
	...
	protected pin_code_reply_cp newInstance() { return new pin_code_reply_cp(); }
	public static pin_code_reply_cp[] newArray(int arrayLength) {
		return Structure.newArray(pin_code_reply_cp.class, arrayLength);
	}
